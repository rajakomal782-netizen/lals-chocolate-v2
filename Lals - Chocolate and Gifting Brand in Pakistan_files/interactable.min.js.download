 ...
 (function( $ ) {
   ...
   */
    ...
    geckoShopify.mobileNav = function () {
      ...
      // });
      mobileNav.on("click", ".menu-item-has-children .nav_link_icon.JAVA2", function (e) {
        e.preventDefault();
        var _this = $(this), _parent = _this.parent().parent();
        mobileNav.find('.item-level-0').not(_parent).removeClass("nt_opended").children("ul").slideUp(200);
        ClickToActive(_this, _parent);
      });

      mobileNav.on("click", ".menu-item-has-children .nav_link_icon.JAVA3", function (e) {
        e.preventDefault();
        var _this = $(this), _parent = _this.parent().parent();
        ClickToActive(_this, _parent);
      });
